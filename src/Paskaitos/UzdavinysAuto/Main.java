package Paskaitos.UzdavinysAuto;
...
public class Main {
    public static void main(String[] args) {
        ...
        automobiliai.add(new Automobilis("BUB125", "Golf", new Savininkas("Antanukas", "Burba")));
        automobiliai.add(new Automobilis("HAS543", "Golf", new Savininkas("Petras", "Burba")));

//        automobiliai.sort(new Comparator<Automobilis>() { //anonimine klase
//            @Override
...
//        });
        ...
        // lambda israiska
        automobiliai.sort (Comparator.comparing((Automobilis o) -> o.getSavininkas().getPavarde())
