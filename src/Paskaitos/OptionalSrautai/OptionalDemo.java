...
public class OptionalDemo {
    public static void main(String[] args) {
        ...
        List<Integer> listas = Arrays.asList(10, null, 0, 4, 5); //mes exceptiona nes null lyginamas

        Optional<Integer> i = rastiPirma(listas, a -> a!=null && a < 10 && a > 0); //optional reikalingi, kad isvengtume bedu su null
