...
class Main {
    public static void main(String[] args) {
        ...
        c.metodasKurisNiekoNegrazina(); //metodai su void gali buti kvieciami sitaip

        c.metodasKurisGrazinaIntegeri();            //
        int x = c.metodasKurisGrazinaIntegeri();    //metodai, grazinantys reiksme, kvieciami sitaip
